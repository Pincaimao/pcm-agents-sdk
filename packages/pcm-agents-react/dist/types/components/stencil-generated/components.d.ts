...
import { PcmDigitalHuman as PcmDigitalHumanElement } from "pcm-agents/dist/components/pcm-digital-human.js";
...
import { PcmJlzzModal as PcmJlzzModalElement } from "pcm-agents/dist/components/pcm-jlzz-modal.js";
...
import { PcmVirtualChatModal as PcmVirtualChatModalElement } from "pcm-agents/dist/components/pcm-virtual-chat-modal.js";
...
type PcmAppChatModalEvents = {
    ...
    onTokenInvalid: EventName<CustomEvent<void>>;
    onInterviewEnd: EventName<PcmAppChatModalCustomEvent<InterviewEndEventData>>;
};
...
export declare const PcmDigitalHuman: StencilReactComponent<PcmDigitalHumanElement, PcmDigitalHumanEvents>;
...
export declare const PcmJlzzModal: StencilReactComponent<PcmJlzzModalElement, PcmJlzzModalEvents>;
...
type PcmMnmsModalEvents = {
    onModalClosed: EventName<CustomEvent<void>>;
    onInterviewEnd: EventName<PcmMnmsModalCustomEvent<InterviewEndEventData>>;
...
type PcmMnmsZpModalEvents = {
    onModalClosed: EventName<CustomEvent<void>>;
    onInterviewEnd: EventName<PcmMnmsZpModalCustomEvent<InterviewEndEventData>>;
