...
| `defaultQuery`           | `default-query`            | 默认查询文本                           | `string`                | `'你好'`      |
| `employeeId`             | `employee-id`              | 数字员工ID，从聘才猫开发平台创建数字员工后，点击分享SDK获取 | `string`                | `""`        |
...
| `showSuggestedQuestions` | `show-suggested-questions` | 是否显示推荐问题                         | `boolean`               | `true`      |
